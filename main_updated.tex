...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Visualization Tools}{:\hspace{1.77cm} Amazon QuickSight} \\
     \textbf{Other Tools}{:\hspace{3.04cm} pgAdmin, Git/Github, CI/CD} \\
    }}
 \end{itemize}
%-------------------------------------------------------------------
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{\textbf{Client Engagement 1 : Data Platform Modernization using PySpark}}
      ...
      \resumeItemListStart
      \resumeItem{\textbf{Client Engagement 2 : Data Pipeline Implementation and Analytics Development}}
